...
async function extractWTMTrainingData() {
  console.log('🚀 Starting WTM Training Data Extraction...');
...
if (require.main === module) {
  extractWTMTrainingData()
    .then((result) => {
      ...
      const fs = require('fs');
      const outputPath = path.join(__dirname, 'wtm-training-data.json');
...
module.exports = { extractWTMTrainingData };
